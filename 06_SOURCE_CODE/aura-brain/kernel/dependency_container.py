"""Kernel-level dependency container.

This mirrors the application container but is kept in the `kernel` package
to avoid circular imports while bootstrapping core services.
"""
