...
class SpeechModel(Model):
    """Adapter for speech-oriented models."""
    ...
    def initialize(self) -> None:
        ...
        self.register_capability(ModelCapability(name="speech", description="Speech recognition and synthesis"))
    ...
    def health_check(self) -> ModelHealth:
        return ModelHealth(healthy=self.is_ready(), message="Speech model ready", status=self.state.status)
