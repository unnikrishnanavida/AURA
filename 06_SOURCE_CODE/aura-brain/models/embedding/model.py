...
class EmbeddingModel(Model):
    """Adapter for embedding-oriented models."""
    ...
    def initialize(self) -> None:
        ...
        self.register_capability(ModelCapability(name="embedding", description="Vector embedding generation"))
    ...
    def health_check(self) -> ModelHealth:
        return ModelHealth(healthy=self.is_ready(), message="Embedding model ready", status=self.state.status)
